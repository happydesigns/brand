...
<template>
  <div :class="exampleClass">
    <ComponentExampleActions
      v-if="actionExampleNames.has(props.name)"
      :name="props.name"
    />

    <ComponentExampleForms
      v-else-if="formExampleNames.has(props.name)"
      :name="props.name"
    />

    <ComponentExampleFeedback
      v-else-if="feedbackExampleNames.has(props.name)"
      :name="props.name"
    />
    ...
    >
      ...
      <UDrawer
        title="Mobile settings"
        description="Use drawers for compact edge-based flows."
      >
        <UButton
          label="Open drawer"
          color="neutral"
    ...
    <div
      v-else-if="props.name === 'page-hero'"
    ...
    >
        ...
        <div class="space-y-3">
          ...
          <div class="grid gap-3 sm:grid-cols-2">
            <div class="flex min-h-28 items-center justify-center rounded-sm border border-default bg-warm-white p-5">
              <img
                :src="wordmarkLogo"
                alt="happydesigns wordmark on light surface"
                class="h-6 w-auto"
              >
            </div>
            <div class="flex min-h-28 items-center justify-center rounded-sm border border-default bg-graphite p-5">
              <img
                :src="wordmarkLogoInverse"
                alt="happydesigns inverse wordmark on dark surface"
                class="h-6 w-auto"
              >
            </div>
          </div>
        ...
        <div class="space-y-3">
          ...
          <div class="grid gap-3 sm:grid-cols-2">
            <div class="flex min-h-28 items-center justify-center rounded-sm border border-default bg-warm-white p-5">
              <img
                :src="symbolLogo"
                alt="happydesigns symbol on light surface"
                class="size-16"
              >
            </div>
            <div class="flex min-h-28 items-center justify-center rounded-sm border border-default bg-graphite p-5">
              <img
                :src="symbolLogo"
                alt="happydesigns symbol on dark surface"
                class="size-16"
              >
            </div>
          </div>
      ...
      <p class="text-sm text-muted">
        Wordmarks swap for contrast. The full symbol keeps its original colors across light and dark surfaces.
      </p>
    </div>
    ...
    <div
      v-else-if="props.name === 'publishing-editorial-pattern'"
    ...
    >
      ...
      <p class="mt-1 text-sm text-muted">
        Dashboard, publishing, chat, and editor families now have brand guidance.
      </p>
    </UCard>
